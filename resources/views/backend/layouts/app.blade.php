...
<head>
    ...
    <link href="backend/plugins/multi-select/css/multi-select.css" rel="stylesheet">
   ...
   <!-- Page Loader -->
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                               <a href="pages/widgets/cards/no-header.html">Gifts</a>
                           </li>
                           <li>
                               <a href="pages/widgets/cards/no-header.html">Orders</a>
                           </li>
                           <li>
                               <a href="pages/widgets/cards/no-header.html">Payments</a>
                           </li>
                       </ul>
                    </li>
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="pages/ui/badges.html">Offers</a>
                            </li>

                            <li>
                                <a href="pages/ui/breadcrumbs.html">On Sale</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="pages/forms/basic-form-elements.html">Customers</a>
                            </li>
                            <li>
                                <a href="pages/forms/advanced-form-elements.html">Group</a>
                            </li>
                            <li>
                                <a href="pages/forms/form-examples.html">Feedback</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="pages/medias/image-gallery.html">Products</a>
                            </li>
                            <li>
                                <a href="pages/medias/carousel.html">Sales Reports</a>
                            </li>
                            <li>
                                <a href="pages/medias/carousel.html">Shopping Cart</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="pages/charts/morris.html">Templates</a>
                            </li>
                            <li>
                                <a href="pages/charts/flot.html">Send Newslatter</a>
                            </li>
                            <li>
                                <a href="pages/charts/chartjs.html">Subscribers</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="pages/examples/sign-in.html">Email</a>
                            </li>
                            <li>
                                <a href="pages/examples/sign-up.html">Product Settings</a>
                            </li>
                            <li>
                                <a href="pages/examples/forgot-password.html">Units</a>
                            </li>
                            <li>
                                <a href="pages/examples/blank.html">Social Media</a>
                            </li>
                            <li>
                                <a href="pages/examples/404.html">Shipment</a>
                            </li>
                            <li>
                                <a href="pages/examples/500.html">Payments</a>
                            </li>
                            <li>
                                <a href="pages/examples/500.html">Reward Points</a>
                            </li>
                            <li>
                                <a href="pages/examples/500.html">Gift card</a>
                            </li>
                        </ul>
                    </li>
                </ul>
    ...
    <link href="//cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/css/toastr.min.css" rel="stylesheet">
     <script type="text/javascript">
       var category_url = "<?php echo route('category-control.index'); ?>";
       var product_url = "<?php echo route('product-control.index'); ?>";
     </script>
