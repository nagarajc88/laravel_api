...
Route::get('/master-category',['uses' => 'Frontend\Categories\CategoryController@index']);
Route::post('/category-product-list',['uses' => 'Frontend\Products\ProductsController@getCategoryProducts']);
