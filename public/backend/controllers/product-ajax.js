...
$("#product_form_details").submit(function(e) {
    var form_action = $("#product_form_details").attr("action");
    if($("#product_name").val()==""){
...
$("#product_type").on("change",function(){
    if($(this).val()==1){
     $("#sparetab").css("display","none");
    }else if($(this).val()==2){
     $("#sparetab").css("display","block");
    }else if($(this).val()==3){
     $("#sparetab").css("display","none");
    }
});